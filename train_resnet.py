"""
train_resnet.py
Entrenamiento preliminar ResNet50 + CBAM
...
# ── Bloque ResNet con CBAM insertado ───────────────────────
class ResNetBlockCBAM(nn.Module):
    """Envuelve un bloque original de ResNet e inserta CBAM después."""
...
class ResNet50CBAM(nn.Module):
    def __init__(self, num_classes=4):
        ...
        # Capas residuales — insertar CBAM en layer3 y layer4
        self.layer1 = base.layer1  # 256 ch — sin CBAM
        self.layer2 = base.layer2  # 512 ch — sin CBAM
        self.layer3 = nn.Sequential(  # 1024 ch — con CBAM al final
            base.layer3,
            CBAM(1024)
        )
        self.layer4 = nn.Sequential(  # 2048 ch — con CBAM al final
            base.layer4,
            CBAM(2048)
        )
...
def entrenar():
    ...
    # ── FASE 2 ────────────────────────────────────────────
    print(f"\n{'='*55}")
    print(f"FASE 2 — Fine-tuning (layer3 + layer4 + CBAM + cabezal)")
    print(f"{'='*55}")
